...
latex_documents = [
    (master_doc, 'dragonfly-trace.tex', 'dragonfly-trace Documentation',
...
man_pages = [
    (master_doc, 'dragonfly-trace', 'dragonfly-trace Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dragonfly-trace', 'dragonfly-trace Documentation',
     author, 'dragonfly-trace', 'One line description of project.',
     'Miscellaneous'),
]
